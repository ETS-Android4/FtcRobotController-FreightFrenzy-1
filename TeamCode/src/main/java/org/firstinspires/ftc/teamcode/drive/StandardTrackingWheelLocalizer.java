...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 15; // in; distance between the left and right wheels (needs to be tuned probably) //used to be 8.25
    public static double FORWARD_OFFSET = -4.5; // in; offset of the lateral wheel (needs to be tuned probably)
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
                //TODO: -0.5 is for 2022 SEASON! CHANGE FOR FUTURE ROBOT DESIGNS
                new Pose2d(-1.25, 4.75, 0), // left
                new Pose2d(-1.25, -4.75, 0), // right
                new Pose2d(FORWARD_OFFSET, -1.75, Math.toRadians(90)) // front
        ));

        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightFront"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "outtakeLift"));
